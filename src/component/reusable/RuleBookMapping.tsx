...
const RuleBookMapping = ()=>{
  ...
  const [files, setFiles] = useState<File[]>([]);
    ...
    return (
<>
<div className="flex justify-center md:px-40  px-5">
        <div className="box-border rounded-2xl p-5 bg-gray-100 w-full ">
          <form className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-6  gap-4 items-center ">
              <div className="md:col-start-3 md:col-span-2 px-10">
                <Select
                  options={options}
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {[
                ...
                <div key={field.id} className="px-10">
                  <Select
                    options={options}
                    label={field.label}
...
export default RuleBookMapping;